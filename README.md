...
**494 tests passed, 5 skipped · `mypy --strict` clean · 8 distinct verification
models registered** — as of 2026-08-06. This is a project that argues nothing should be trusted on
...
- **Laundered sources** — curated-but-unverified material (the Knowledge Graph) treated as fact. A human
